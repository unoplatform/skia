...
SK_API sk_imagefilter_croprect_t* sk_imagefilter_croprect_new(void);
...
SK_API sk_imagefilter_t* sk_imagefilter_new_arithmetic(
    ...
    sk_imagefilter_t* foreground /*NULL*/,
    const sk_imagefilter_croprect_t* cropRect /*NULL*/);
SK_API sk_imagefilter_t* sk_imagefilter_new_image_source(
    sk_image_t* image,
    const sk_rect_t* srcRect,
    const sk_rect_t* dstRect,
    sk_filter_quality_t filterQuality);
SK_API sk_imagefilter_t* sk_imagefilter_new_image_source_default(
    sk_image_t* image);
SK_API sk_imagefilter_t* sk_imagefilter_new_paint(
