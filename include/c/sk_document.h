...
SK_API sk_document_t* sk_document_create_pdf_from_stream(sk_wstream_t* stream);
SK_API sk_document_t* sk_document_create_pdf_from_stream_with_metadata(sk_wstream_t* stream, const sk_document_pdf_metadata_t* metadata);
...
SK_API void sk_document_close(sk_document_t* document);
