...
SK_API sk_colortable_t* sk_colortable_new(const sk_pmcolor_t* colors, int count);
SK_API int sk_colortable_count(const sk_colortable_t* ctable);
SK_API void sk_colortable_read_colors(const sk_colortable_t* ctable, sk_pmcolor_t** colors);
