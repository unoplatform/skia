...
SK_API sk_path_effect_t* sk_path_effect_create_discrete(float segLength, float deviation, uint32_t seedAssist /*0*/, void* nullPad);
SK_API sk_path_effect_t* sk_path_effect_create_corner(void* nullPad, float radius);
...
SK_API sk_path_effect_t* sk_path_effect_create_2d_line(void* nullPad, float width, const sk_matrix_t* matrix);
...
SK_API sk_path_effect_t* sk_path_effect_create_trim(float start, float stop, sk_path_effect_trim_mode_t mode);
