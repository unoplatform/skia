...
SK_API sk_colorfilter_t* sk_colorfilter_new_luma_color(void);
SK_API sk_colorfilter_t* sk_colorfilter_new_high_contrast(const sk_highcontrastconfig_t* config);
