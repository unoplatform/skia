...
SK_API void sk_canvas_draw_image_rect(sk_canvas_t*, const sk_image_t*, const sk_rect_t* src, const sk_rect_t* dst, const sk_paint_t*);
SK_API void sk_canvas_draw_picture(sk_canvas_t*, const sk_picture_t*, const sk_matrix_t*, const sk_paint_t*);
SK_API void sk_canvas_draw_drawable(sk_canvas_t*, sk_drawable_t*, const sk_matrix_t*);
...
SK_API void* sk_canvas_draw_point(sk_canvas_t*, const sk_paint_t*, float, float);
SK_API void* sk_canvas_draw_line(sk_canvas_t* ccanvas, float x0, float y0, float x1, float y1, sk_paint_t* cpaint);
SK_API int sk_canvas_draw_text (sk_canvas_t*, float x, float y, const char* text, size_t byteLength, const sk_paint_t* paint);
...
SK_API int sk_canvas_draw_text_on_path (sk_canvas_t*, const char* text, size_t byteLength, const sk_path_t*path, const sk_paint_t* paint, void* nullpPad, float hOffset, float vOffset);
SK_API int sk_canvas_draw_text_blob (sk_canvas_t*, float x, float y, sk_textblob_t* text, const sk_paint_t* paint);
...
SK_API void sk_canvas_clip_rrect_with_operation(sk_canvas_t* t, const sk_rrect_t* crect, sk_clipop_t op, bool doAA);
SK_API bool sk_canvas_get_local_clip_bounds(sk_canvas_t* t, sk_rect_t* cbounds);
SK_API bool sk_canvas_get_device_clip_bounds(sk_canvas_t* t, sk_irect_t* cbounds);
...
SK_API void sk_canvas_draw_bitmap_nine(sk_canvas_t* t, const sk_bitmap_t* bitmap, const sk_irect_t* center, const sk_rect_t* dst, const sk_paint_t* paint);
SK_API void sk_canvas_draw_image_nine(sk_canvas_t* t, const sk_image_t* image, const sk_irect_t* center, const sk_rect_t* dst, const sk_paint_t* paint);
SK_API void sk_canvas_draw_vertices(sk_canvas_t* ccanvas, sk_vertices_t* vertices, sk_blendmode_t mode, const sk_paint_t* paint);

SK_API sk_nodraw_canvas_t* sk_nodraw_canvas_new(int width, int height);
SK_API void sk_nodraw_canvas_destroy(sk_nodraw_canvas_t*);

SK_API sk_nway_canvas_t* sk_nway_canvas_new(int width, int height);
SK_API void sk_nway_canvas_destroy(sk_nway_canvas_t*);
SK_API void sk_nway_canvas_add_canvas(sk_nway_canvas_t*, sk_canvas_t* canvas);
SK_API void sk_nway_canvas_remove_canvas(sk_nway_canvas_t*, sk_canvas_t* canvas);
SK_API void sk_nway_canvas_remove_all(sk_nway_canvas_t*);

SK_API sk_overdraw_canvas_t* sk_overdraw_canvas_new(sk_canvas_t* canvas);
SK_API void sk_overdraw_canvas_destroy(sk_overdraw_canvas_t* canvas);
