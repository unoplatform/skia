...
SK_API int sk_canvas_draw_text_on_path (sk_canvas_t*, float hOffset, float vOffset, const char* text, size_t byteLength, const sk_path_t*path, const sk_paint_t* paint);
