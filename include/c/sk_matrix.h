...
SK_API void sk_matrix44_set_translate (sk_matrix44_t* matrix, float dx, float dy, float dz);
SK_API void sk_matrix44_pre_translate (sk_matrix44_t* matrix, float dx, float dy, float dz);
SK_API void sk_matrix44_post_translate (sk_matrix44_t* matrix, float dx, float dy, float dz);
SK_API void sk_matrix44_set_scale (sk_matrix44_t* matrix, float sx, float sy, float sz);
SK_API void sk_matrix44_pre_scale (sk_matrix44_t* matrix, float sx, float sy, float sz);
SK_API void sk_matrix44_post_scale (sk_matrix44_t* matrix, float sx, float sy, float sz);
