...
SK_API bool sk_filestream_is_valid(sk_stream_filestream_t* cstream);

////////////////////////////////////////////////////////////////////////////////

SK_API sk_stream_memorystream_t* sk_memorystream_new(void);
...
SK_API bool sk_filewstream_is_valid(sk_wstream_filestream_t* cstream);

SK_API sk_wstream_dynamicmemorystream_t* sk_dynamicmemorywstream_new(void);
SK_API sk_stream_asset_t* sk_dynamicmemorywstream_detach_as_stream(sk_wstream_dynamicmemorystream_t* cstream);
SK_API sk_data_t* sk_dynamicmemorywstream_detach_as_data(sk_wstream_dynamicmemorystream_t* cstream);
SK_API void sk_dynamicmemorywstream_copy_to(sk_wstream_dynamicmemorystream_t* cstream, void* data);
SK_API bool sk_dynamicmemorywstream_write_to_stream(sk_wstream_dynamicmemorystream_t* cstream, sk_wstream_t* dst);
...
SK_API bool sk_wstream_newline(sk_wstream_t* cstream);
