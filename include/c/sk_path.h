...
SK_API void sk_path_add_rrect(sk_path_t*, const sk_rrect_t*, sk_path_direction_t);
...
SK_API void sk_path_add_poly(sk_path_t* cpath, const sk_point_t* points, int count, bool close);
SK_API uint32_t sk_path_get_segment_masks(sk_path_t* cpath);
SK_API bool sk_path_is_oval(sk_path_t* cpath, sk_rect_t* bounds);
SK_API bool sk_path_is_rrect(sk_path_t* cpath, sk_rrect_t* bounds);
SK_API bool sk_path_is_line(sk_path_t* cpath, sk_point_t line [2]);
SK_API bool sk_path_is_rect(sk_path_t* cpath, sk_rect_t* rect, bool* isClosed, sk_path_direction_t* direction);
...
/* Path Op Builder */
SK_API sk_opbuilder_t* sk_opbuilder_new(void);
...
/* Path Measure */
SK_API sk_pathmeasure_t* sk_pathmeasure_new(void);
